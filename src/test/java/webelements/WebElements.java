...
//	}
	//*Find all input boxes and assign to List of web elements -> 2
    //* Find all drop down boxes and assign to another List of web elements -> 3
    //* Find all check boxes and assign to another List of web elements -> 9
    //* Find all radio boxes and assign to another List of web elements -> 9
    //* Find all buttons and assign to another List of web elements -> 1
